...
Therefore, from the output waveform in *gtkwave* we can see the expected result for all logic gates in the form of signals.
The waveforms are displayed for first 10ns as a = b = 0, the next 10ns i.e till 20ns, a = 1, b = 0, the next 30ns i.e. till 30ns a = 0, b = 1, and finally a = b = 1, the result of the logic gates is given below a and b.
